...
# var_imp_all <- importance(infest_rf, type = 1)
# write.csv(var_imp_all, "var_imp_all.csv")
...
# var_imp_top_ten <- importance(rf_ten_vars, type = 1)
# write.csv(var_imp_top_ten, "var_imp_top_ten.csv")
...
# var_imp_risk_vars <- importance(rf_risk_vars, type = 1)
# write.csv(var_imp_risk_vars, "var_imp_risk_vars.csv")
...
#saving var importance for plot
# var_imp_risk_vars_no_temp <- importance(rf_risk_vars_temp, type = 1)
# write.csv(var_imp_risk_vars_no_temp, "var_imp_risk_vars_no_temp.csv")
